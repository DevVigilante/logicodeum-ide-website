        ...
        <footer style={styles.footer}>
            <div style={styles.container}>
                ...
                <div style={styles.section}>
                    <h3 style={styles.logo}>Logicodeum IDE</h3>
                    <p style={styles.text}>
                        A IDE built by us, build for you, to build your
                        software.
                    </p>
                </div>
                ...
                <div style={styles.section}>
                    ...
                    <ul style={styles.list}>
                        ...
                        <li>
                            <a
                                href="https://www.instagram.com/innovative_cst?igsh=MWQ0bDFsbGJ0NmpobQ=="
                                style={styles.link}
                            >
                                Instagram
                            </a>
